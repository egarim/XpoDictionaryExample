...
namespace XpoDictionaryExample.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class XpoDictionaryExampleModule : ModuleBase {
    public XpoDictionaryExampleModule() {
		// 
		// XpoDictionaryExampleModule
		// 
